...
export const CATEGORIES = {
	'Resources': [],
	'Research Review': ['Social Psychology', 'Health Psychology', 'Neuropsychology', 'Cognitive Psychology', 'Developmental Psychology', 'Clinical Psychology'],
...
export const AllSubcategoriesEnum = allSubcategoryNames.length > 0
